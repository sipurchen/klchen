...
2. Navigate to \path\to\project\scripts\
...
Location: \path\to\LLMs\Gemma4_E4B
...
ollama create gemma4-e4b-opt -f \path\to\project\Modelfile.gemma4-e4b-optimized
